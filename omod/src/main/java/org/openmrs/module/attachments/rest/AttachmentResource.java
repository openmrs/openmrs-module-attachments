...
public class AttachmentResource extends DataDelegatingCrudResource<Attachment> implements Uploadable {
	 ...
	 * only if a patient
	 * parameter exists in the request set on the {@link RequestContext}, optional
	 * encounter, visit ,
	 * includeEncounterless , includeVoided request parameters can be specified to
	 * filter the
	 * attachments.
	 *
	 * @param context
	 ...
	 * either be a
	 * MultipartFile or a base64 encoded image. This class will only implement the
	 * methods used by
	 * ComplexObsSaver#saveImageAttachment. This way we won't have to make any
	 * changes to the
	 * implementation of ComplexObsSaver#saveImageAttachment and will also make very
	 * little change to
	 * the AttachmentResource1_10#upload implementation. This is also helps us avoid
	 * adding an extra
	 * dependency to MockMultipartFile for converting the base64 encoded String to a
	 * MultipartFile
	 * object.
	 */
