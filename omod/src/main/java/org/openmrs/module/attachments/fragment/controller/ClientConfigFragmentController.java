...
public class ClientConfigFragmentController {
	...
	public static Map<String, Object> getClientConfig(AttachmentsContext context, UiUtils ui) {
		...
		jsonConfig.put("searchUrL", "/" + ui.contextPath() + "/ws" + AttachmentsConstants.SEARCH_ATTACHMENT_URL);
	...
	/**
	 * The controller method to be invoked from the client-side. For instance with JavaScript
