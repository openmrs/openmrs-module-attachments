...
public class DashboardWidgetFragmentController {
  ...
  public void controller(FragmentModel model, @FragmentParam("patient") PatientDomainWrapper patientWrapper, UiUtils ui, @InjectBeans AttachmentsContext context)
  {
