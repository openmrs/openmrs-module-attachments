...
angular.module('att.page.main', ['obsService', 'session', 'att.widget.fileUpload', 'att.widget.gallery', 'att.widget.thumbnail']);
...
angular.module('att.widget.complexObsEncounter', ['obsService', 'att.widget.gallery', 'att.widget.thumbnail', 'att.widget.modalImage']);
...
angular.module('att.widget.thumbnail', ['att.service.attachmentService', 'att.service.complexObsCacheService', 'ngDialog', 'att.widget.modalImage','att.service.moduleUtils', 'cp.ng.fix-image-orientation'])
