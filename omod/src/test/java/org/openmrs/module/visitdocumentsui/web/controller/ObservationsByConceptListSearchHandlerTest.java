...
//	@Ignore("The standardTestDataset.xml does not create mappings. Skipping this test")
	...
	public void parseConceptList_shouldHandleMappingsAndUuids() throws Exception {
		...
		when(conceptServiceMock.getConceptByMapping(CONCEPT_2_NUMBER, CONCEPT_2_SOURCE)).thenReturn(conceptService.getConceptByUuid(CONCEPT_2_UUID));
		...
		ObservationsByConceptListSearchHandler searchHandler =  new ObservationsByConceptListSearchHandler();
