...
public class AttachmentsMockMultipartFile implements MultipartFile {
	...
	public AttachmentsMockMultipartFile(String name, String originalFilename, String contentType, File file) {
