...
/**
 * Extends {@link ComplexData} so that it provides a method to extract the
 * underlying byte array. Whenever we need to extend {@link ComplexData} we
 * should actually extend this class.
 * 
...
public class BaseComplexData extends ComplexData {
	...
	/**
	 * This returns the byte array out of a complex data's inner data. This is
	 * borrowed from ComplexObsServlet in core.
	 * 
