...
public interface AttachmentsService extends OpenmrsService {
	 ...
	 * with any visits or encounters.
	 *
	 * @param includeVoided
	 *            Specifies whether the underlying complex obs that are fetched
	 *            should include voided ones or not.
	 * @throws APIException
	 *             if non-complex obs are mistakenly returned
	 */
	 ...
	 *            Specifies whether the underlying attachments that are fetched
	 *            should include attachments that are not associated with any visits
	 *            or encounters.
	 * @throws APIException
	 *             if non-complex obs are mistakenly returned
	 */
	...
	/**
	 * Get a patient's attachments that are not associated with any visits or
	 * encounters.
	 *
	 * @param includeVoided
	 *            Specifies whether the underlying complex obs that are fetched
	 ...
	 *
	 * @param encounter
	 *            the encounter which attachment to get
	 * @param includeVoided
	 *            Specifies whether the underlying complex obs that are fetched
	 *            should include voided ones or not.
	 * @throws APIException
	 ...
	 *
	 * @param visit
	 *            the visit which attachments to get
	 * @param includeVoided
	 *            Specifies whether the underlying complex obs that are fetched
	 *            should include voided ones or not.
	 * @throws APIException
