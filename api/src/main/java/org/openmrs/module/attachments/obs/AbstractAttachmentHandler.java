...
public abstract class AbstractAttachmentHandler implements ComplexObsHandler {
	...
	/**
	 * <p>
	 * The saveThumbnailOrRename method checks image dimension to see if the image
	 * is small enough to be its own thumbnail. If so, it will rename the image file
	 * by appending the <b>NO_THUMBNAIL_SUFFIX</b> to the file. Otherwise, it will
	 * create a small thumbnail file alongside the original file to be used as
	 * thumbnail image.
	 * </p>
	 *
	 * @param savedFile
