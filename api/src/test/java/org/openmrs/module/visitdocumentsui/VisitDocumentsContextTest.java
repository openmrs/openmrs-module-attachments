...
public class VisitDocumentsContextTest {
   
   private VisitDocumentsContext context = new VisitDocumentsContext();
   ...
   public void context_shouldReturnSimpleMap() {
      ...
      String gpName = VisitDocumentsConstants.GP_CONCEPT_COMPLEX_UUID_MAP;
   ...
   public void context_shouldReturnList() {
      ...
      String gpName = VisitDocumentsConstants.GP_CONCEPT_COMPLEX_UUID_LIST;
